...
mod tests {
    use super::{
        ...
        ensure_mcp_sql_database_switch_allowed, instance_port_file_name, mongo_filter_is_effectively_unbounded,
        mongo_pipeline_has_write_stage, resolve_connection, resolve_mongo_database, resolve_mongo_target_values,
        write_port_file, write_port_file_for_instance, AppState,
    };
