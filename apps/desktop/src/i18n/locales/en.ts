...
export default {
  ...
  connection: {
    ...
    gateway: "DBX Gateway",
    gatewayAdd: "Add Gateway",
    gatewayDefaultName: "DBX Gateway",
    gatewayRoute: "Gateway Route",
    gatewayRoutePlaceholder: "Select an Edge and target",
    gatewayRouteSearch: "Search Edge or target",
    gatewayRoutesEmpty: "No authorized routes found",
    gatewayRoutesRefresh: "Refresh authorized routes",
    gatewayUseAsConnectionInfo: "Use as connection information",
    gatewayUseAsConnectionInfoHint: "Use the selected Gateway route instead of the connection host and port. The Edge target manages the actual database address.",
    gatewayHostOverrideHint: "This Gateway is being used as the connection target, so its Edge route replaces the host and port fields. Clear the option to enter a host and port manually.",
    gatewayRouteManagedInConnectionInfo: "This route is used as connection information. Change it from the Host field on the Connection tab.",
    gatewayEdgeOnline: "Online",
    gatewayEdgeOffline: "{edge} is offline",
    gatewayNoProfiles: "Create a Gateway profile in Settings > Tunnels first.",
    gatewayProfileRequired: "Select a shared DBX Gateway profile.",
    gatewayIdentityMissing: "The Gateway client identity is missing. Import or select it in Settings > Tunnels.",
    gatewayRouteRequired: "Select an online Gateway route.",
    gatewayRoutesUnavailable: "Refresh the authorized Gateway routes before connecting.",
    gatewayRouteUnavailable: "The selected Gateway route is no longer authorized.",
    gatewayOnlyOne: "A connection can use only one DBX Gateway layer.",
    gatewayInvalidOrder: "DBX Gateway must be the final transport layer.",
    networkPath: "Connection network path",
    networkPathClient: "DBX Client",
    networkPathGatewayMain: "Gateway Main",
    networkPathGatewayEdge: "Gateway Edge",
    networkPathDatabase: "Database",
    networkPathStatus: {
      idle: "Not tested",
      testing: "Testing",
      success: "Connected",
  ...
  tabs: {
    ...
    autoRefreshSecondsUnit: "s",
    customAutoRefreshInterval: "Other",
    customAutoRefreshPrompt: "Enter refresh interval in seconds:",
    invalidAutoRefreshInterval: "Enter a positive whole number of seconds.",
  ...
  settings: {
    ...
    tunnelsAddGateway: "Add Gateway",
    tunnelsGatewayMainUrl: "Main URL",
    tunnelsGatewayIdentity: "Client Identity",
    tunnelsGatewayIdentityPlaceholder: "Select an imported identity",
    tunnelsGatewayIdentityImport: "Import Identity",
    tunnelsGatewayIdentityNamePlaceholder: "Identity name",
    tunnelsGatewayIdentityPasswordPlaceholder: "PKCS#12 password",
    tunnelsGatewaySelectIdentity: "Select PKCS#12",
    tunnelsGatewayNoIdentitySelected: "No file selected",
    tunnelsGatewaySelectPasswordFile: "Select password file",
    tunnelsGatewayPasswordFileFailed: "Failed to read password file: {message}",
    tunnelsGatewayImportIdentity: "Import",
    tunnelsGatewayDesktopOnly: "Gateway identities require the desktop app.",
    tunnelsGatewayIdentityReferences: "{count} profiles",
    tunnelsGatewayDeleteIdentity: "Delete identity",
    tunnelsGatewayDeleteIdentityConfirm: "Delete identity '{name}'? It is referenced by {count} Gateway profiles.",
    tunnelsGatewayIdentityImported: "Gateway identity imported",
    tunnelsGatewayIdentityImportFailed: "Failed to import Gateway identity: {message}",
    tunnelsGatewayIdentityDeleted: "Gateway identity deleted",
    tunnelsGatewayIdentityDeleteFailed: "Failed to delete Gateway identity: {message}",
    tunnelsGatewayServerCa: "Server CA",
    tunnelsGatewayServerCaPlaceholder: "Paste the dedicated Main Gateway CA in PEM format",
    tunnelsGatewayImportCa: "Import CA PEM",
    tunnelsGatewayCaImportFailed: "Failed to import CA PEM: {message}",
    tunnelsGatewaySpkiPin: "SPKI SHA-256",
    tunnelsGatewaySpkiPinPlaceholder: "Optional 64-character lowercase hex pin",
    tunnelsGatewayTimeout: "Timeout (seconds)",
    ...
    dataDirTitle: "Configuration directory",
    dataDirChange: "Change",
    dataDirReset: "Reset",
    dataDirDescription: "Default directory: {path}",
    dataDirRestartRequired: "The configuration directory will apply after restarting DBX.",
    dataDirEnvLocked: "Currently controlled by the DBX_DATA_DIR environment variable: {path}",
    dataDirSource: {
      default: "Default",
      env: "Environment",
