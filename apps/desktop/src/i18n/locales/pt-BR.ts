...
export default withEnglishFallback({
  ...
  connection: {
    ...
    gateway: "DBX Gateway",
    gatewayAdd: "Adicionar Gateway",
    gatewayDefaultName: "DBX Gateway",
    gatewayRoute: "Rota do Gateway",
    gatewayRoutePlaceholder: "Selecione um Edge e destino",
    gatewayRouteSearch: "Buscar Edge ou destino",
    gatewayRoutesEmpty: "Nenhuma rota autorizada",
    gatewayRoutesRefresh: "Atualizar rotas autorizadas",
    gatewayEdgeOnline: "Online",
    gatewayEdgeOffline: "{edge} está offline",
    gatewayNoProfiles: "Crie primeiro um perfil Gateway em Configurações > Túneis.",
    gatewayProfileRequired: "Selecione um perfil DBX Gateway compartilhado.",
    gatewayIdentityMissing: "A identidade de cliente Gateway está ausente. Importe ou selecione-a em Configurações > Túneis.",
    gatewayRouteRequired: "Selecione uma rota Gateway online.",
    gatewayRoutesUnavailable: "Atualize as rotas Gateway autorizadas antes de conectar.",
    gatewayRouteUnavailable: "A rota Gateway selecionada não está mais autorizada.",
    gatewayOnlyOne: "Uma conexão pode usar apenas uma camada DBX Gateway.",
    gatewayInvalidOrder: "DBX Gateway deve ser a última camada de transporte.",
    networkPath: "Rota de rede da conexão",
    networkPathClient: "Cliente DBX",
    networkPathGatewayMain: "Gateway Main",
    networkPathGatewayEdge: "Gateway Edge",
    networkPathDatabase: "Banco de dados",
    networkPathStatus: {
      idle: "Não testado",
      testing: "Testando",
      success: "Conectado",
  ...
  tabs: {
    ...
    customAutoRefreshInterval: "Outro",
    customAutoRefreshPrompt: "Insira o intervalo de atualização em segundos:",
    invalidAutoRefreshInterval: "Insira um número inteiro positivo de segundos.",
  ...
  settings: {
    ...
    tunnelsAddGateway: "Adicionar Gateway",
    tunnelsGatewayMainUrl: "URL do Main",
    tunnelsGatewayIdentity: "Identidade do cliente",
    tunnelsGatewayIdentityPlaceholder: "Selecione uma identidade importada",
    tunnelsGatewayIdentityImport: "Importar identidade",
    tunnelsGatewayIdentityNamePlaceholder: "Nome da identidade",
    tunnelsGatewayIdentityPasswordPlaceholder: "Senha PKCS#12",
    tunnelsGatewaySelectIdentity: "Selecionar PKCS#12",
    tunnelsGatewayNoIdentitySelected: "Nenhum arquivo selecionado",
    tunnelsGatewaySelectPasswordFile: "Selecionar arquivo de senha",
    tunnelsGatewayPasswordFileFailed: "Falha ao ler o arquivo de senha: {message}",
    tunnelsGatewayImportIdentity: "Importar",
    tunnelsGatewayDesktopOnly: "Identidades Gateway exigem o aplicativo desktop.",
    tunnelsGatewayIdentityReferences: "{count} perfis",
    tunnelsGatewayDeleteIdentity: "Excluir identidade",
    tunnelsGatewayDeleteIdentityConfirm: "Excluir a identidade '{name}'? Ela é usada por {count} perfis Gateway.",
    tunnelsGatewayIdentityImported: "Identidade Gateway importada",
    tunnelsGatewayIdentityImportFailed: "Falha ao importar identidade Gateway: {message}",
    tunnelsGatewayIdentityDeleted: "Identidade Gateway excluída",
    tunnelsGatewayIdentityDeleteFailed: "Falha ao excluir identidade Gateway: {message}",
    tunnelsGatewayServerCa: "CA do servidor",
    tunnelsGatewayServerCaPlaceholder: "Cole a CA PEM dedicada do Main Gateway",
    tunnelsGatewayImportCa: "Importar CA PEM",
    tunnelsGatewayCaImportFailed: "Falha ao importar a CA PEM: {message}",
    tunnelsGatewaySpkiPin: "SPKI SHA-256",
    tunnelsGatewaySpkiPinPlaceholder: "Pin hexadecimal minúsculo opcional de 64 caracteres",
    tunnelsGatewayTimeout: "Tempo limite (segundos)",
    tunnelsGatewayTestMain: "Testar Main",
