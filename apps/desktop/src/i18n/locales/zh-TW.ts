...
export default withEnglishFallback({
  ...
  connection: {
    ...
    gateway: "DBX Gateway",
    gatewayAdd: "新增 Gateway",
    gatewayDefaultName: "DBX Gateway",
    gatewayRoute: "Gateway 路由",
    gatewayRoutePlaceholder: "選擇 Edge 與目標",
    gatewayRouteSearch: "搜尋 Edge 或目標",
    gatewayRoutesEmpty: "找不到可用的授權路由",
    gatewayRoutesRefresh: "重新整理授權路由",
    gatewayUseAsConnectionInfo: "作為連線資訊",
    gatewayUseAsConnectionInfoHint: "使用所選 Gateway 路由取代連線資訊中的主機與連接埠。資料庫實際位址由 Edge 的目標設定管理。",
    gatewayHostOverrideHint: "目前 Gateway 已啟用「作為連線資訊」，資料庫目標由所選 Edge 路由決定，因此主機與連接埠已替換為 Gateway 資料庫目標。取消此選項後可恢復手動填寫。",
    gatewayRouteManagedInConnectionInfo: "已作為連線資訊使用，請在「連線資訊」的主機項目中修改 Gateway 路由。",
    gatewayEdgeOnline: "上線",
    gatewayEdgeOffline: "{edge} 已離線",
    gatewayNoProfiles: "請先在 設定 > 隧道 中建立 Gateway 設定檔。",
    gatewayProfileRequired: "請選擇共用的 DBX Gateway 設定檔。",
    gatewayIdentityMissing: "Gateway 用戶端身分不存在，請在 設定 > 隧道 中匯入或重新選擇。",
    gatewayRouteRequired: "請選擇上線的 Gateway 路由。",
    gatewayRoutesUnavailable: "連線前請重新整理 Gateway 授權路由。",
    gatewayRouteUnavailable: "選取的 Gateway 路由已不在授權範圍內。",
    gatewayOnlyOne: "一個連線只能使用一個 DBX Gateway 層。",
    gatewayInvalidOrder: "DBX Gateway 必須是最後一個傳輸層。",
    networkPath: "連線網路鏈路",
    networkPathClient: "DBX 用戶端",
    networkPathGatewayMain: "Gateway 主閘道",
    networkPathGatewayEdge: "Gateway 邊緣閘道",
    networkPathDatabase: "資料庫",
    networkPathStatus: {
      idle: "未測試",
      testing: "測試中",
      success: "已連通",
  ...
  tabs: {
    ...
    customAutoRefreshInterval: "其他",
    customAutoRefreshPrompt: "請輸入重新整理間隔，單位為秒：",
    invalidAutoRefreshInterval: "請輸入正整數秒數。",
  ...
  settings: {
    ...
    tunnelsAddGateway: "新增 Gateway",
    tunnelsGatewayMainUrl: "Main 位址",
    tunnelsGatewayIdentity: "用戶端身分",
    tunnelsGatewayIdentityPlaceholder: "選擇已匯入的身分",
    tunnelsGatewayIdentityImport: "匯入身分",
    tunnelsGatewayIdentityNamePlaceholder: "身分名稱",
    tunnelsGatewayIdentityPasswordPlaceholder: "PKCS#12 密碼",
    tunnelsGatewaySelectIdentity: "選擇 PKCS#12",
    tunnelsGatewayNoIdentitySelected: "未選擇檔案",
    tunnelsGatewaySelectPasswordFile: "選擇密碼檔案",
    tunnelsGatewayPasswordFileFailed: "密碼檔案讀取失敗：{message}",
    tunnelsGatewayImportIdentity: "匯入",
    tunnelsGatewayDesktopOnly: "Gateway 身分僅可在桌面版使用。",
    tunnelsGatewayIdentityReferences: "{count} 個設定檔引用",
    tunnelsGatewayDeleteIdentity: "刪除身分",
    tunnelsGatewayDeleteIdentityConfirm: "確定刪除身分「{name}」嗎？目前有 {count} 個 Gateway 設定檔引用它。",
    tunnelsGatewayIdentityImported: "Gateway 身分已匯入",
    tunnelsGatewayIdentityImportFailed: "Gateway 身分匯入失敗：{message}",
    tunnelsGatewayIdentityDeleted: "Gateway 身分已刪除",
    tunnelsGatewayIdentityDeleteFailed: "Gateway 身分刪除失敗：{message}",
    tunnelsGatewayServerCa: "伺服器 CA",
    tunnelsGatewayServerCaPlaceholder: "貼上 Main Gateway 專用 CA 的 PEM 內容",
    tunnelsGatewayImportCa: "匯入 CA PEM",
    tunnelsGatewayCaImportFailed: "CA PEM 匯入失敗：{message}",
    tunnelsGatewaySpkiPin: "SPKI SHA-256",
    tunnelsGatewaySpkiPinPlaceholder: "選填，64 位小寫十六進位 Pin",
    tunnelsGatewayTimeout: "逾時（秒）",
    ...
    dataDirChange: "變更",
    dataDirReset: "恢復預設",
    dataDirDescription: "預設目錄：{path}",
    dataDirRestartRequired: "設定目錄將在重新啟動 DBX 後生效。",
    dataDirEnvLocked: "目前由 DBX_DATA_DIR 環境變數控制：{path}",
    dataDirSource: {
      default: "預設",
      env: "環境變數",
      configured: "已設定",
