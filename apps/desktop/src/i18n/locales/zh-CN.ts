...
export default withEnglishFallback({
  ...
  connection: {
    ...
    gateway: "DBX Gateway",
    gatewayAdd: "添加 Gateway",
    gatewayDefaultName: "DBX Gateway",
    gatewayRoute: "Gateway 路由",
    gatewayRoutePlaceholder: "选择 Edge 和目标",
    gatewayRouteSearch: "搜索 Edge 或目标",
    gatewayRoutesEmpty: "没有可用的授权路由",
    gatewayRoutesRefresh: "刷新授权路由",
    gatewayUseAsConnectionInfo: "作为连接信息",
    gatewayUseAsConnectionInfoHint: "使用所选 Gateway 路由替代连接信息中的主机和端口。数据库实际地址由 Edge 的目标配置管理，客户端无需填写。",
    gatewayHostOverrideHint: "当前 Gateway 已启用“作为连接信息”，数据库目标由所选 Edge 路由决定，因此主机和端口输入已替换为 Gateway 数据库目标。取消该选项后可恢复手动填写主机和端口。",
    gatewayRouteManagedInConnectionInfo: "已作为连接信息使用，请在“连接信息”的主机项中修改 Gateway 路由。",
    gatewayEdgeOnline: "在线",
    gatewayEdgeOffline: "{edge} 已离线",
    gatewayNoProfiles: "请先在 设置 > 隧道 中创建 Gateway 档案。",
    gatewayProfileRequired: "请选择共享的 DBX Gateway 档案。",
    gatewayIdentityMissing: "Gateway 客户端身份不存在，请在 设置 > 隧道 中导入或重新选择。",
    gatewayRouteRequired: "请选择在线的 Gateway 路由。",
    gatewayRoutesUnavailable: "连接前请刷新 Gateway 授权路由。",
    gatewayRouteUnavailable: "所选 Gateway 路由已不在授权范围内。",
    gatewayOnlyOne: "一个连接只能使用一个 DBX Gateway 层。",
    gatewayInvalidOrder: "DBX Gateway 必须是最后一个传输层。",
    networkPath: "连接网络链路",
    networkPathClient: "DBX 客户端",
    networkPathGatewayMain: "Gateway 主网关",
    networkPathGatewayEdge: "Gateway 边缘网关",
    networkPathDatabase: "数据库",
    networkPathStatus: {
      idle: "未测试",
      testing: "测试中",
      success: "已连通",
  ...
  tabs: {
    ...
    customAutoRefreshPrompt: "请输入刷新间隔，单位为秒：",
    invalidAutoRefreshInterval: "请输入正整数秒数。",
  ...
  settings: {
    ...
    tunnelsGatewayMainUrl: "Main 地址",
    tunnelsGatewayIdentity: "客户端身份",
    tunnelsGatewayIdentityPlaceholder: "选择已导入的身份",
    tunnelsGatewayIdentityImport: "导入身份",
    tunnelsGatewayIdentityNamePlaceholder: "身份名称",
    tunnelsGatewayIdentityPasswordPlaceholder: "PKCS#12 密码",
    tunnelsGatewaySelectIdentity: "选择 PKCS#12",
    tunnelsGatewayNoIdentitySelected: "未选择文件",
    tunnelsGatewaySelectPasswordFile: "选择密码文件",
    tunnelsGatewayPasswordFileFailed: "密码文件读取失败：{message}",
    tunnelsGatewayImportIdentity: "导入",
    tunnelsGatewayDesktopOnly: "Gateway 身份仅可在桌面端使用。",
    tunnelsGatewayIdentityReferences: "{count} 个档案引用",
    tunnelsGatewayDeleteIdentity: "删除身份",
    tunnelsGatewayDeleteIdentityConfirm: "确定删除身份“{name}”吗？当前有 {count} 个 Gateway 档案引用它。",
    tunnelsGatewayIdentityImported: "Gateway 身份已导入",
    tunnelsGatewayIdentityImportFailed: "Gateway 身份导入失败：{message}",
    tunnelsGatewayIdentityDeleted: "Gateway 身份已删除",
    tunnelsGatewayIdentityDeleteFailed: "Gateway 身份删除失败：{message}",
    tunnelsGatewayServerCa: "服务端 CA",
    tunnelsGatewayServerCaPlaceholder: "粘贴 Main Gateway 专用 CA 的 PEM 内容",
    tunnelsGatewayImportCa: "导入 CA PEM",
    tunnelsGatewayCaImportFailed: "CA PEM 导入失败：{message}",
    tunnelsGatewaySpkiPin: "SPKI SHA-256",
    tunnelsGatewaySpkiPinPlaceholder: "可选，64 位小写十六进制 Pin",
    tunnelsGatewayTimeout: "超时（秒）",
    ...
    dataDirChange: "更改",
    dataDirReset: "恢复默认",
    dataDirDescription: "默认目录：{path}",
    dataDirRestartRequired: "配置目录将在重启 DBX 后生效。",
    dataDirEnvLocked: "当前由 DBX_DATA_DIR 环境变量控制：{path}",
    dataDirSource: {
      default: "默认",
      env: "环境变量",
      configured: "已配置",
