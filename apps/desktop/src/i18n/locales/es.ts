...
export default withEnglishFallback({
  ...
  connection: {
    ...
    gateway: "DBX Gateway",
    gatewayAdd: "Añadir Gateway",
    gatewayDefaultName: "DBX Gateway",
    gatewayRoute: "Ruta de Gateway",
    gatewayRoutePlaceholder: "Selecciona un Edge y un destino",
    gatewayRouteSearch: "Buscar Edge o destino",
    gatewayRoutesEmpty: "No hay rutas autorizadas",
    gatewayRoutesRefresh: "Actualizar rutas autorizadas",
    gatewayEdgeOnline: "En línea",
    gatewayEdgeOffline: "{edge} está sin conexión",
    gatewayNoProfiles: "Crea primero un perfil Gateway en Ajustes > Túneles.",
    gatewayProfileRequired: "Selecciona un perfil DBX Gateway compartido.",
    gatewayIdentityMissing: "Falta la identidad de cliente Gateway. Impórtala o selecciónala en Ajustes > Túneles.",
    gatewayRouteRequired: "Selecciona una ruta Gateway en línea.",
    gatewayRoutesUnavailable: "Actualiza las rutas Gateway autorizadas antes de conectar.",
    gatewayRouteUnavailable: "La ruta Gateway seleccionada ya no está autorizada.",
    gatewayOnlyOne: "Una conexión solo puede usar una capa DBX Gateway.",
    gatewayInvalidOrder: "DBX Gateway debe ser la última capa de transporte.",
    networkPath: "Ruta de red de la conexión",
    networkPathClient: "Cliente DBX",
    networkPathGatewayMain: "Gateway Main",
    networkPathGatewayEdge: "Gateway Edge",
    networkPathDatabase: "Base de datos",
    networkPathStatus: {
      idle: "Sin probar",
      testing: "Probando",
      success: "Conectado",
  ...
  tabs: {
    ...
    customAutoRefreshInterval: "Otro",
    customAutoRefreshPrompt: "Introduce el intervalo de actualización en segundos:",
    invalidAutoRefreshInterval: "Introduce un número entero positivo de segundos.",
  ...
  settings: {
    ...
    tunnelsAddGateway: "Añadir Gateway",
    tunnelsGatewayMainUrl: "URL de Main",
    tunnelsGatewayIdentity: "Identidad de cliente",
    tunnelsGatewayIdentityPlaceholder: "Selecciona una identidad importada",
    tunnelsGatewayIdentityImport: "Importar identidad",
    tunnelsGatewayIdentityNamePlaceholder: "Nombre de identidad",
    tunnelsGatewayIdentityPasswordPlaceholder: "Contraseña PKCS#12",
    tunnelsGatewaySelectIdentity: "Seleccionar PKCS#12",
    tunnelsGatewayNoIdentitySelected: "Ningún archivo seleccionado",
    tunnelsGatewaySelectPasswordFile: "Seleccionar archivo de contraseña",
    tunnelsGatewayPasswordFileFailed: "No se pudo leer el archivo de contraseña: {message}",
    tunnelsGatewayImportIdentity: "Importar",
    tunnelsGatewayDesktopOnly: "Las identidades Gateway requieren la aplicación de escritorio.",
    tunnelsGatewayIdentityReferences: "{count} perfiles",
    tunnelsGatewayDeleteIdentity: "Eliminar identidad",
    tunnelsGatewayDeleteIdentityConfirm: "¿Eliminar la identidad '{name}'? La usan {count} perfiles Gateway.",
    tunnelsGatewayIdentityImported: "Identidad Gateway importada",
    tunnelsGatewayIdentityImportFailed: "No se pudo importar la identidad Gateway: {message}",
    tunnelsGatewayIdentityDeleted: "Identidad Gateway eliminada",
    tunnelsGatewayIdentityDeleteFailed: "No se pudo eliminar la identidad Gateway: {message}",
    tunnelsGatewayServerCa: "CA del servidor",
    tunnelsGatewayServerCaPlaceholder: "Pega la CA PEM dedicada de Main Gateway",
    tunnelsGatewayImportCa: "Importar CA PEM",
    tunnelsGatewayCaImportFailed: "No se pudo importar la CA PEM: {message}",
    tunnelsGatewaySpkiPin: "SPKI SHA-256",
    tunnelsGatewaySpkiPinPlaceholder: "Pin hexadecimal opcional de 64 caracteres en minúsculas",
    tunnelsGatewayTimeout: "Tiempo de espera (segundos)",
    tunnelsGatewayTestMain: "Probar Main",
