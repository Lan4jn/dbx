...
export default withEnglishFallback({
  ...
  connection: {
    ...
    gateway: "DBX Gateway",
    gatewayAdd: "Aggiungi Gateway",
    gatewayDefaultName: "DBX Gateway",
    gatewayRoute: "Route Gateway",
    gatewayRoutePlaceholder: "Seleziona Edge e destinazione",
    gatewayRouteSearch: "Cerca Edge o destinazione",
    gatewayRoutesEmpty: "Nessuna route autorizzata",
    gatewayRoutesRefresh: "Aggiorna route autorizzate",
    gatewayEdgeOnline: "Online",
    gatewayEdgeOffline: "{edge} è offline",
    gatewayNoProfiles: "Crea prima un profilo Gateway in Impostazioni > Tunnel.",
    gatewayProfileRequired: "Seleziona un profilo DBX Gateway condiviso.",
    gatewayIdentityMissing: "Identità client Gateway mancante. Importala o selezionala in Impostazioni > Tunnel.",
    gatewayRouteRequired: "Seleziona una route Gateway online.",
    gatewayRoutesUnavailable: "Aggiorna le route Gateway autorizzate prima della connessione.",
    gatewayRouteUnavailable: "La route Gateway selezionata non è più autorizzata.",
    gatewayOnlyOne: "Una connessione può usare un solo livello DBX Gateway.",
    gatewayInvalidOrder: "DBX Gateway deve essere l'ultimo livello di trasporto.",
    networkPath: "Percorso di rete della connessione",
    networkPathClient: "Client DBX",
  ...
  tabs: {
    ...
    customAutoRefreshInterval: "Altro",
    customAutoRefreshPrompt: "Inserisci l'intervallo di aggiornamento in secondi:",
    invalidAutoRefreshInterval: "Inserisci un numero intero positivo di secondi.",
  ...
  settings: {
    ...
    tunnelsAddGateway: "Aggiungi Gateway",
    tunnelsGatewayMainUrl: "URL Main",
    tunnelsGatewayIdentity: "Identità client",
    tunnelsGatewayIdentityPlaceholder: "Seleziona un'identità importata",
    tunnelsGatewayIdentityImport: "Importa identità",
    tunnelsGatewayIdentityNamePlaceholder: "Nome identità",
    tunnelsGatewayIdentityPasswordPlaceholder: "Password PKCS#12",
    tunnelsGatewaySelectIdentity: "Seleziona PKCS#12",
    tunnelsGatewayNoIdentitySelected: "Nessun file selezionato",
    tunnelsGatewaySelectPasswordFile: "Seleziona file password",
    tunnelsGatewayPasswordFileFailed: "Impossibile leggere il file password: {message}",
    tunnelsGatewayImportIdentity: "Importa",
    tunnelsGatewayDesktopOnly: "Le identità Gateway richiedono l'app desktop.",
    tunnelsGatewayIdentityReferences: "{count} profili",
    tunnelsGatewayDeleteIdentity: "Elimina identità",
    tunnelsGatewayDeleteIdentityConfirm: "Eliminare l'identità '{name}'? È usata da {count} profili Gateway.",
    tunnelsGatewayIdentityImported: "Identità Gateway importata",
    tunnelsGatewayIdentityImportFailed: "Importazione identità Gateway non riuscita: {message}",
    tunnelsGatewayIdentityDeleted: "Identità Gateway eliminata",
    tunnelsGatewayIdentityDeleteFailed: "Eliminazione identità Gateway non riuscita: {message}",
    tunnelsGatewayServerCa: "CA server",
    tunnelsGatewayServerCaPlaceholder: "Incolla la CA PEM dedicata del Main Gateway",
    tunnelsGatewayImportCa: "Importa CA PEM",
    tunnelsGatewayCaImportFailed: "Importazione CA PEM non riuscita: {message}",
