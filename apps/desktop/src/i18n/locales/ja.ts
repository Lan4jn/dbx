...
export default withEnglishFallback({
  ...
  connection: {
    ...
    gateway: "DBX Gateway",
    gatewayAdd: "Gateway を追加",
    gatewayDefaultName: "DBX Gateway",
    gatewayRoute: "Gateway ルート",
    gatewayRoutePlaceholder: "Edge とターゲットを選択",
    gatewayRouteSearch: "Edge またはターゲットを検索",
    gatewayRoutesEmpty: "許可されたルートがありません",
    gatewayRoutesRefresh: "許可されたルートを更新",
    gatewayEdgeOnline: "オンライン",
    gatewayEdgeOffline: "{edge} はオフラインです",
    gatewayNoProfiles: "先に 設定 > トンネル で Gateway プロファイルを作成してください。",
    gatewayProfileRequired: "共有 DBX Gateway プロファイルを選択してください。",
    gatewayIdentityMissing: "Gateway クライアント ID がありません。設定 > トンネル でインポートまたは再選択してください。",
    gatewayRouteRequired: "オンラインの Gateway ルートを選択してください。",
    gatewayRoutesUnavailable: "接続前に Gateway の許可ルートを更新してください。",
    gatewayRouteUnavailable: "選択した Gateway ルートは許可されていません。",
    gatewayOnlyOne: "1 つの接続で使用できる DBX Gateway レイヤーは 1 つだけです。",
    gatewayInvalidOrder: "DBX Gateway は最後のトランスポートレイヤーである必要があります。",
    networkPath: "接続ネットワーク経路",
    networkPathClient: "DBX クライアント",
    networkPathGatewayMain: "Gateway Main",
    networkPathGatewayEdge: "Gateway Edge",
    networkPathDatabase: "データベース",
    networkPathStatus: {
      idle: "未テスト",
      testing: "テスト中",
      success: "接続済み",
  ...
  tabs: {
    ...
    autoRefreshSecondsUnit: "秒",
    customAutoRefreshInterval: "その他",
    customAutoRefreshPrompt: "更新間隔を秒単位で入力してください:",
    invalidAutoRefreshInterval: "正の整数秒を入力してください。",
  ...
  settings: {
    ...
    tunnelsAddGateway: "Gateway を追加",
    tunnelsGatewayMainUrl: "Main URL",
    tunnelsGatewayIdentity: "クライアント ID",
    tunnelsGatewayIdentityPlaceholder: "インポート済み ID を選択",
    tunnelsGatewayIdentityImport: "ID のインポート",
    tunnelsGatewayIdentityNamePlaceholder: "ID 名",
    tunnelsGatewayIdentityPasswordPlaceholder: "PKCS#12 パスワード",
    tunnelsGatewaySelectIdentity: "PKCS#12 を選択",
    tunnelsGatewayNoIdentitySelected: "ファイル未選択",
    tunnelsGatewaySelectPasswordFile: "パスワードファイルを選択",
    tunnelsGatewayPasswordFileFailed: "パスワードファイルを読み取れませんでした: {message}",
    tunnelsGatewayImportIdentity: "インポート",
    tunnelsGatewayDesktopOnly: "Gateway ID はデスクトップアプリでのみ使用できます。",
    tunnelsGatewayIdentityReferences: "{count} プロファイル",
    tunnelsGatewayDeleteIdentity: "ID を削除",
    tunnelsGatewayDeleteIdentityConfirm: "ID「{name}」を削除しますか？{count} 個の Gateway プロファイルから参照されています。",
    tunnelsGatewayIdentityImported: "Gateway ID をインポートしました",
    tunnelsGatewayIdentityImportFailed: "Gateway ID のインポートに失敗しました: {message}",
    tunnelsGatewayIdentityDeleted: "Gateway ID を削除しました",
    tunnelsGatewayIdentityDeleteFailed: "Gateway ID の削除に失敗しました: {message}",
    tunnelsGatewayServerCa: "サーバー CA",
    tunnelsGatewayServerCaPlaceholder: "Main Gateway 専用 CA の PEM を貼り付け",
    tunnelsGatewayImportCa: "CA PEM をインポート",
    tunnelsGatewayCaImportFailed: "CA PEM のインポートに失敗しました: {message}",
