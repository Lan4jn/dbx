...
export const importGatewayIdentity = forward("importGatewayIdentity");
export const listGatewayIdentities = forward("listGatewayIdentities");
export const deleteGatewayIdentity = forward("deleteGatewayIdentity");
export const listGatewayRoutes = forward("listGatewayRoutes");
export const testGatewayProfile = forward("testGatewayProfile");
