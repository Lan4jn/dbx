...
const autoRefreshCustomIntervalSeconds = ref(15);
...
function applyCustomAutoRefreshInterval(value: string) {
  const seconds = parseAutoRefreshIntervalSeconds(value);
  if (seconds == null) {
    toast(t("tabs.invalidAutoRefreshInterval"), 4000);
    return;
  }
  autoRefreshCustomIntervalSeconds.value = seconds;
...
const autoRefreshToolbarCapability = computed<DataGridToolbarAutoRefreshCapability>(() => ({
  ...
  customLabel: t("tabs.customAutoRefreshInterval"),
  customUnitLabel: t("tabs.autoRefreshSecondsUnit"),
  customInputLabel: t("tabs.customAutoRefreshPrompt"),
  customIntervalSeconds: autoRefreshCustomIntervalSeconds.value,
  customIntervalSelected: !AUTO_REFRESH_INTERVAL_OPTIONS.includes(autoRefreshIntervalSeconds.value),
  onToggle: toggleAutoRefresh,
  onSelectInterval: setAutoRefreshInterval,
  onApplyCustomInterval: applyCustomAutoRefreshInterval,
}));
