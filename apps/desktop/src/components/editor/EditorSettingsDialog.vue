...
import { AlertTriangle, ArrowLeft, Check, CheckCircle2, CircleHelp, Cloud, Copy, Download, ExternalLink, FolderOpen, GripVertical, Loader2, Moon, PackageSearch, Palette, Pencil, Plus, RefreshCw, RotateCcw, Search, Settings, Sun, SunMoon, Terminal, Trash2, Upload, X } from "@lucide/vue";
...
async function chooseDataDir() {
  ...
  try {
    ...
    const selected = await open({ directory: true, multiple: false, defaultPath: displayedDataDir.value || undefined });
